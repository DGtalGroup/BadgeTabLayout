package com.dev.nikuru.badgetablibrary;
...
/**
 * Edited by nikuru on 24/11/2016.
 */
public class BadgeTabLayout extends TabLayout {
    ...
    public static final class Builder {
        ...
        Drawable mBadgeDrwable;
        Integer mIconColorFilter;
        //Integer mBadgeColorFilter;
        int mBadgeCount = 0;
        int minDisplayValue = 1;
        int maxDisplayValue = 9;
        ...
        private Builder(TabLayout parent, @NonNull TabLayout.Tab tab) {
            ...
            this.mBadgeDrwable = ContextCompat.getDrawable(mContext, R.drawable.icon_badge);
    ...
    /*hide*/
        private Builder badge(boolean hasBadge) {
            mHasBadge = hasBadge;
            return this;
        }
        ...
        /**
         * Set badge color. Use this when user wants to change badges's color filter
         * For future release
         * @param color
         * @return this builder

        public Builder badgeColor(Integer color) {
            mBadgeColorFilter = color;
            return this;
        }
        */
        /**
        ...
        public Builder increase() {
            int dv;
            try{
                dv = Integer.parseInt(mBadgeTextView.getText().toString());
            ...
            mBadgeCount =
                    mBadgeTextView == null ? INVALID_NUMBER
                            :
                            dv + 1;
            return this;
        }
        ...
        /**
         * set maximum display value 9 by default
         *
         * @return this mBadgeCount
         */
        ...
        public Builder setMax(int max){
            ...
            if(minDisplayValue <= max)     maxDisplayValue = max;
            return this;
        }

        /**
         * set minimum display value 0 by default
         *
         * @return this mBadgeCount
         */

        public Builder setMin( int min){
            if(maxDisplayValue >= min)     minDisplayValue = min;
            return this;
        }
        ...
        public void build() {
            ...
            if (mBadgeTextView != null ) {
                mBadgeTextView.setText(formatBadgeNumber(mBadgeCount, maxDisplayValue));

                if (mHasBadge && mBadgeCount >= minDisplayValue) {
     ...
     */
    private static String formatBadgeNumber(int value, int mxv) {
        if (value < 0) {
            return "-" + (value * -1);
        }
